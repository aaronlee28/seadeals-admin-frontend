...
const Login = () => {
  ...
  // mock token
  const sellerToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJTZWEgRGVhbHMiLCJleHAiOjE2NjQ5NTg0OTUsImlhdCI6MTY2NDk1NzU5NSwidXNlciI6eyJ1c2VyX2lkIjoyLCJlbWFpbCI6ImFsaWNlLmRvZUBtYWlsLmNvbSIsInVzZXJuYW1lIjoiYWxpY2UuZG9lIiwid2FsbGV0X2lkIjoyfSwic2NvcGUiOiJ1c2VyIHNlbGxlciIsInR5cGUiOiJhY2Nlc3NfdG9rZW4ifQ.AHW9JqEb6LkmBCTGWJLFFcnGaHjIOZbqoXG1AjZiJxU';
